...
- Flujo soportado: registro/login (guarda JWT), ver listas, crear lista con productos (nombre, descripcion, fecha dd/mm/aa), marcar/desmarcar productos (actualiza estado), duplicar lista.
