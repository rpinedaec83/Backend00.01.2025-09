...
function ejercicio04() {
    ...
    alert("Los tres números mayores son: " + mayor0 + ", " + mayor1 + ", " + mayor2);

}

function ejercicio05() {
    let cantidadZapatos = prompt("Ingrese la cantidad de zapatos a comprar: (Precio Unitario = $80)");
...
function ejercicio07() {
    let membresia = prompt("Precio de helados $10" + "\nIngrese el tipo de membresía (A, B, C):");
...
function ejercicio15() {
    ...
    let numeroOperacion = prompt("Ingrese un número del 1 al 2 para seleccionar la operación:\n1. Para convertir cm a pulg \n2. Para convertir lb a kg");
...
function ejercicio16() {
    let numero = prompt("Ingrese un número del 1 al 7 para determinar el día de la semana:");
    numero = parseInt(numero);
...
function ejercicio17() {
    ...
    alert("Un segundo después, la hora es: " + hora.toString().padStart(2, '0') + ":" + minuto.toString().padStart(2, '0') + ":" + segundo.toString().padStart(2, '0'));
}
...
function ejercicio18() {
    ...
    alert("El precio por CD es: $" + precio + "\nEl total a pagar es: $" + totalPagar);
...
function ejercicio19() {
    let = numeroTrabajador = prompt("Ingrese el número de trabajador (1-4): \n1. Cajero\n2. Servidor\n3. Preparador de mezclas\n4. Mantenimiento");

    numeroTrabajador = parseInt(numeroTrabajador);
    if (isNaN(numeroTrabajador) || numeroTrabajador < 1 || numeroTrabajador > 4) {
        return alert("Por favor, ingrese un número de trabajador válido entre 1 y 4.");
    }
